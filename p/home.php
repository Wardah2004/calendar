...
<html lang="en">
    ...
    <head>
        ...
        <!-- Fav and touch icons -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="C:\wamp64\www\p\images/logo.jfif">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="C:\wamp64\www\p\images/logo.jfif">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="images/apple-touch-icon-72.png">
        <link rel="apple-touch-icon-precomposed" href="C:\wamp64\www\p\images/logo.jfif">
        <link rel="shortcut icon" href="C:\wamp64\www\p\images/logo.jfif">
    ...
    <body>
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container">
                    <a href="#" class="brand">
                        <img src="C:\wamp64\www\p\images/logo.jfif" width="120" height="40" alt="Logo" />
        ...
        <div id="home">
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    <!-- Start first slide -->
                    <div class="da-slide">
                        <h2 class="fittext2">نرحب بكم متدربات الكلية التقنية للبنات</h2>
                        <h4>calendar of activities ماهو </h4>
                        <p>هو موقع الكتروني لتنظيم مواعيد ومعلومات الانشطة والفعاليات من وداخل الكلية</p>
                        
                        <div class="da-img">
                            <img src="C:\Users\Warda\Downloads/da.jfif" width="300" alt="image01">
                        </div>
                    </div>
                    <!-- End first slide -->
                    <!-- Start second slide -->
                    <div class="da-slide">
                        ...
                        <div class="da-img">
                            <img src="C:\Users\Warda\Downloads/d.jfif" width="310" alt="image02">
                        </div>
                    </div>
                    <!-- End second slide -->
                    <!-- Start third slide -->
                    <div class="da-slide">
                        ...
                        <div class="da-img">
                            <img src="C:\Users\Warda\Downloads/m.jfif" width="300" alt="image03">
                        </div>
                    </div>
                    <!-- Start third slide -->
            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img src="C:\Users\Warda\Downloads/k.jfif"/>
                            </div>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img src="C:\Users\Warda\Downloads/f.jfif"/>
                            </div>
                            <h3>الرحلات</h3>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img src="C:\Users\Warda\Downloads/j.jfif"/>
                            </div>
                            <h3>ورش العمل </h3>
...
ان انضمامكم المستمر في الدورات يفيدكم مستقبلا في سوق العمل و يعزز المستوى التعليمي لديكم و يكسبكم العديد من الخبرات التي تفيدكم علما و عملا</p>
                ...
                <div id="single-project">
                    <div id="slidingDiv" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloads/yy.jfif" />
                        </div>
                        <div class="span6">
                    ...
                    <div id="slidingDiv1" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloadsf/q.jfif"/>
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv2" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloads/ss.jfif"/>
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv3" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloads/q.jfif"/>
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv4" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloads/ii.jfif"/>
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv5" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloads/t.jfif"/>
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv6" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloads/Lk.jfif"/>
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <div id="slidingDiv8" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <img src="C:\Users\Warda\Downloads/m.jfif"/>
                        </div>
                        <div class="span6">
                            <div class="project-description">
                                <div class="project-title clearfix">
                    ...
                    <ul id="portfolio-grid" class="thumbnails row">
                        ...
                        <li class="span4 mix identity">
                            <div class="thumbnail">
                                <img src="C:\Users\Warda\Downloads/sh.jfif"/>
                        ...
                        <li class="span4 mix web">
                            <div class="thumbnail">
                                <img src="C:\Users\Warda\Downloads/qz.jfif"/>
                        ...
                        <li class="span4 mix photo">
                            <div class="thumbnail">
                                <img src="C:\Users\Warda\Downloads/jl.jfif"/>
                        ...
                        <li class="span4 mix identity">
                            <div class="thumbnail">
                                <img src="C:\Users\Warda\Downloads/mk.jfif"/>
            ...
            <div class="container">
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="C:\Users\Warda\Downloads/n.jfif"/>
                    ...
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            <img src="C:\Users\Warda\Downloads/z.jfif"/>
                            <h3>فرحة العيد</h3>
                            <ul class="social">
                    ...
                    <div class="container">
                        <div class="row-fluid">
                            <div class="span5 contact-form centered"><a href="comment.php">اضافة تعليق</a>
                               ...
                               <form id="contact-form" method="post" action="w1.php">-->
                                    <!--<div class="control-group">
                                       <div class="controls">
                                            <input class="span12" type="text" id="name" name="name" placeholder="*التخصص" />
                                            <div class="error left-align" id="err-name">التخصص.</div>
                                        </div> 
                                    </div>-->
                                    <!--<div class="control-group">
                                        <div class="controls">
                                            <input class="span12" type="text" id="name" name="name" placeholder="*الاقتراح" />
                                            <div class="error left-align" id="err-name">الاقتراح.</div>
                                        </div>
